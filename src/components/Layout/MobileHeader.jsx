...
const MobileHeader = () => {
  ...
  return (
    ...
    <div className=' '>
        ...
        <Link href={"/"}><li className={`${ route == "/startproject" ? "text-[#ffffff]" : route == "/blogs/[blogId]" ?"text-[#ffffff]": "text-[#808080] " }`}>Home</li></Link>
            ...
            <Link href={"/partnership/core"}><li className={`${ route == "/partnership" ? "text-[#ffffff]" : "text-[#808080] " }`}>Partnership</li></Link>
