  ...
  return (
    <section className="py-[50px]  relative top-[50px]  px-[30px] md:px-[130px]">
      <div className="pt-[50px] pb-[92px]">
        ...
        <div className="pt-[20px] md:pt-[77px] flex flex-col gap-y-[21px]">
          ...
          <h1 className="text-[32px] font-oswald font-bold text-[#3F3F3F] lg:text-[48px] md:text-center ">
            {title}
          </h1>
          
          <div className=" md:px-[120px] xl:px-[200px] xl:pt-[81px]  text-[15px] font-jakarta">
            <h2 className="text-[32px] font-oswald font-bold text-[#3F3F3F]">
              Welcome to Drive Tech
            </h2><br /> <br />
           <p className="tracking-[0.57px]"> These {title} outline the rules and regulations for the use
            of Drive Tech's Website, located at www.drivetech.com.
            <br /> <br />
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use DriveTech if you do not agree to
            ...
            interchangeable and therefore as referring to same. <br /> <br />{" "}
            Cookies <br /> We employ the use of cookies. By accessing DriveTech,
            you agreed to use cookies in agreement with the Drive Tech's Privacy
            ...
            and opinions of Drive Tech,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Drive Tech
            ...
            <br /> Drive Tech reserves the right to monitor all Comments and to
