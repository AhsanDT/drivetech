...
const Idea = ({ title }) => {
  return (
    <section className="w-full border-b border-b-[#747474] lg:border-none  bg-[#37373B] flex justify-center px-[30px] md:px-[80px] xl:px-[250px] py-[38px] h-[223px] top-[4px] relative z-[5]">
