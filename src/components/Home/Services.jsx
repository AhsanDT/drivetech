      ...
      <section className={`w-full linear-grad relative z-[3] ${route == "/" && "top-[-3px]"} top-[6px] md:px-[90px]  `}>
        <div className={`w-full xl:max-[1440px] relative ${route == "/" ? "top-[-94px]": ""}   flex justify-center`}>
          ...
          <div className={`relative ${route == "/" ? "top-[180px] md:top-[180px]" : "top-[130px]" } `}>
            ...
            <div className={`bg-[#ffffff] bg-opacity-[10%] lg:h-[168px] w-full mt-[45px] lg:mt-[150px] flex flex-col gap-y-[24px] justify-center items-center px-[30px] py-[20px] mb-[88px] ${route == "/development" && "mb-[170px] md:mb-[381px]"} ${route == "/services" && "mb-[170px] md:mb-[381px]"}`}>
